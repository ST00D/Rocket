...
//consistantly writes coords, vel, ax, ay, az, but alternates between temp and alt. 


//TEMPERATURE AND ALTITUDE NOT PROPERLY RECORDED. ESPECIALLY ALTITUDE
...
const unsigned long updateInterval = 100; // 500 ms 
const unsigned long sdWriteInterval = 100; // Write every 3 seconds 
...
void loop() { 
  ...
  // Update data and log every 500 ms 
